...
public class TelnetRealm  extends AuthorizingRealm {
    ...
    protected AuthorizationInfo doGetAuthorizationInfo(PrincipalCollection principalCollection) {
        TelnetUser user= (TelnetUser) SecurityUtils.getSubject().getPrincipal();//User{id=1, username='admin', password='3ef7164d1f6167cb9f2658c07d3c2f0a', enable=1}
    ...
    protected AuthenticationInfo doGetAuthenticationInfo(AuthenticationToken token) throws AuthenticationException {
        ...
        TelnetUser user = userService.selectByUsername(username);
    ...
    public void clearUserAuthByUserId(List<Integer> userIds){
        ...
        for (Session session:sessions){
            ...
            if(null != obj && obj instanceof SimplePrincipalCollection){
                ...
                if(null != obj && obj instanceof TelnetUser){
                    TelnetUser user = (TelnetUser) obj;
        ...
        TelnetRealm realm = (TelnetRealm)securityManager.getRealms().iterator().next();
